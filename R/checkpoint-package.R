...
#' * [`use_checkpoint`]: Uses a previously created checkpoint.
#' * [`delete_checkpoint`]: Deletes an existing checkpoint.
#' * [`delete_all_checkpoints`]: Deletes _all_ existing checkpoints.
#' * [`uncheckpoint_session`]: Stops using a checkpoint, restores the library search path and CRAN mirror to their original state.
