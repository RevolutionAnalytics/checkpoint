...
The only way I've found to get `checkpoint()` to work inside an RMarkdown document, is really a bit of a hack. The workaround is to create a manifest of required packages, and write this to an R file in the working directory.
