...
test_that("is.404", {
  describe("is.404 works with http", {
    it("works on http", {
      expect_true(is.404("http://mran.revolutionanalytics.com/snapshot/1972-01-01", warn = FALSE))
  ...
  describe("is.404 works with https", {
    ...
    it("works on https", {
      ...
      expect_true(is.404("https://mran.revolutionanalytics.com/snapshot/1972-01-01", warn = FALSE))
  ...
  describe("is.404 gracefully deals with https URLs when https not supported", {
    ...
    it("works even when https is not supported", {
      with_mock(`checkpoint:::httpsSupported` = function(mran) FALSE, {
        # if(!httpsSupported()) skip("https not supported")
        expect_true(is.404("https://mran.revolutionanalytics.com/snapshot/1972-01-01", warn = FALSE))
        expect_true(is.404("https://mran.revolutionanalytics.com/snapshot", warn = FALSE))
        expect_true(is.404("https://mran.revolutionanalytics.com/snapshot/2015-05-01", warn = FALSE))
      })
