...
test_that("auto-installs knitr and rmarkdown",
{
    ...
    found <- scanForPackages(project = project_root, use.knitr = TRUE, auto.install.knitr = TRUE)
...
test_that("Sweave scans Rnw files with eval=FALSE chunks",
{
    ...
    found <- scanForPackages(project = project_root, use.knitr = FALSE, scan.rnw.with.knitr = FALSE)
